...
```
curl -H "Authorization: token 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" -sO https://raw.githubusercontent.com/tendostore/Scrip-Install-Website-PPOB/main/install.sh && chmod +x install.sh && ./install.sh
```
---
